 ...
 * @param messasge An optional message to display in the toast notification.
 ...
 */
export const showApiToast = (title: string, messasge?: string, error?: any) => {
    if (error) {
        ...
        toast.success(title, { description: messasge });
    }
}